...
struct Total
{
    s_bwd_tracePath_Intermediates_0 _data0;
    s_bwd_tracePaths_Intermediates_0 _data1;
    s_bwd_reparameterizeScreenSample_Intermediates_0 _data2;
    s_bwd_DifferentiableSceneQuery_traceRayInlineDifferentiable_Intermediates_0 _data3;
    s_bwd_DifferentiableSceneQuery_loadIntersectionInfo_Intermediates_0 _data4;
    s_bwd_handleHit_Intermediates_0 _data5;
    s_bwd_computeNEE_Intermediates_0 _data6;
    s_bwd_reparameterizeRay_Intermediates_0 _data7;
    s_bwd_temporaryBsdfEval_Intermediates_0 _data8;
    s_bwd_generateScatterRay_Intermediates_0 _data9;
    s_bwd_s_fwd_computeWarpedPrimalSample_Intermediates_0 _data10;
    s_bwd_s_fwd_traceAsymptoticWeightedMeanIntersection_Intermediates_0 _data11;
    s_bwd_s_fwd_DifferentiableSceneQuery_traceRayInlineDifferentiable_Intermediates_0 _data12;
    s_bwd_s_fwd_DifferentiableSceneQuery_loadIntersectionInfo_Intermediates_0 _data13;
    s_bwd_s_fwd_computeWarpedRay_Intermediates_0 _data14;
    s_bwd_s_fwd_traceAsymptoticWeightedMeanIntersection_Intermediates_1 _data15;
};
